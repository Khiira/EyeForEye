...
$query=mysqli_query($mysqli,"SELECT pu.ID_Publicacion as idPubli, pu.Contenido as Contenido, pu.Fecha as FechaDePublicacion, tp.Nombre_tipo as TipoPublicacion, ca.NombreCategoria as Categoria, us.Nombre_User as NombreUsuario, us.Run_User as Run_User,us.Img_Rostro as img_user 
...
WHERE pu.ID_TipoPublicacion = 2 AND pu.ID_EstadoPubli = 1
