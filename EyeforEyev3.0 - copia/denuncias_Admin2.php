...
$query=$query=mysqli_query($mysqli,"SELECT pu.ID_Publicacion as ID, pu.Contenido as Contenido, pu.Fecha as FechaDePublicacion, tp.Nombre_tipo as TipoPublicacion, ca.NombreCategoria as Categoria, us.Nombre_User as NombreUsuario, us.Img_Rostro as img_user 
...
WHERE pu.ID_Publicacion = '$id_publi'");
?>
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-4">
				...
				<div class="card bg-default publis">
					...
					<a href=""><button class="btn_img_user"><?php echo $datos['img_user']?></button></a><?php echo $datos['NombreUsuario']?>
					</h5>
					<div class="card-body">
						<p class="card-text">
							...
							<br>
							Fecha:<?php echo $datos['FechaDePublicacion']?>
							<br>
							<?php echo $datos['Contenido']?>
						</p>
					</div>
					<div class="card-footer">
						<a href="ctr_admin.php?r=<?php echo $datos['ID']?>&a=mant"><button>Mantener</button></a><a href="ctr_admin.php?r=<?php echo $datos['ID']?>&a=elim"><button>Eliminar</button></a>
					</div>
				</div>
				<?php
					}
