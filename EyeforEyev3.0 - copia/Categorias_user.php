...
<html lang="es">
  ...
  <body>
	...
	<div class="row btn_pag">
		...
		<div class="col-md-4">
        <form action="Categorias_user.php" method="post">
            <select class="form-control" name="s_categoria">
                <?php
			...
			$idCategoria = (isset($_POST['s_categoria']))?$_POST['s_categoria']:"";
			
			
			$query = mysqli_query($mysqli,"SELECT pu.ID_Publicacion, pu.Contenido as Contenido, pu.Fecha as FechaDePublicacion, tp.Nombre_tipo as TipoPublicacion, ca.NombreCategoria as Categoria, us.Nombre_User as NombreUsuario, us.Run_User as Run_User, us.Img_Rostro as img_user 
			...
			WHERE pu.ID_Categoria='$idCategoria' AND pu.ID_EstadoPubli = 1
			...
			?>
				...
				<h5 class="card-header">
						...
						<div class="menu_publi">
							
                        <a href="hacerDenuncia.php?ID=<?php echo $datos['idPubli']?>"><button><i class="fas fa-exclamation-triangle"> Reportar</i></button></a>
					...
					<div class="card-footer">
						...
						<a href="mensajes.php?userio=<?php echo $datos['Run_User']?>" class="menu_icons_cards "><i class="fas fa-comment-dots"></i></a>
